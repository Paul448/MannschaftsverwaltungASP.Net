...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br /> <asp:Table ID="MS_Table" runat="server" BorderWidth="2" GridLines="Both" BorderStyle="Solid" Height="115px" Width="296px">
    </asp:Table> <br />
    <asp:Table ID="Spiele_Table" runat="server" BorderWidth="2" GridLines="Both" BorderStyle="Solid" Height="100px" Width="550px"></asp:Table>
</asp:Content>
